...
class Portfolio_CPT {
	...
	public function save( $post_id ) {
		...
		$mydata = sanitize_text_field( $_POST['beckett_page_skills'] );

		// Update the meta field.
		update_post_meta( $post_id, 'beckett_page_skills', $mydata );
	...
	public function render_meta_box_content( $post ) {
		...
		$value = get_post_meta( $post->ID, 'beckett_page_skills', true );

		// Display the form, using the current value.
		echo '<label for="beckett_page_skills">';
		_e( 'Skills', $this->textdomain );
		echo '</label> ';
		echo '<input type="text" id="page_skills" name="beckett_page_skills"';
